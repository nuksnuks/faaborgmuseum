...
<div class="container">
    ...
    <div class="row" style="margin: 30px -15px;">
        ...
        <div class="col-xs-12 col-sm-6 text-right"><h3><?php echo date('d/n-Y',strtotime(get_field('date_start'))); ?><br /><?php echo get_field('time'); ?></h3></div>
    </div>


    <div class="row" id="turnwhite">
        <div class="col-xs-12 pageheadline"><h3 style="color: #000000;" ><?php echo __('','FaaborgMuseum'); ?></h3></div>
    </div>
